<#
.SYNOPSIS
Create valid build file based on the task passed as inputs

.DESCRIPTION
Helps you build a valid build file, based on all the individual tasks that are passed as inputs

This makes it easy to get a starting point for a new build file, based on the tasks you have build in your array and then passes into the cmdlet

Tasks are expected to be the ones that are part of the module

.PARAMETER Task
Names of the tasks that you want to be part of your build file
...
.EXAMPLE
PS C:\> New-PsLaBuildByTask -Task "Export-LogicApp.AzCli","ConvertTo-LogicApp.Basic","ConvertTo-Arm"
...
.EXAMPLE
PS C:\> New-PsLaBuildByTask -Task "Export-LogicApp.AzCli","ConvertTo-LogicApp.Basic","ConvertTo-Arm" -SubscriptionId "f5608f3d-ab28-49d8-9b4e-1b1f812d12e0" -ResourceGroup "TestRg"
...
.EXAMPLE
PS C:\> New-PsLaBuildByTask -Task "Export-LogicApp.AzCli","ConvertTo-LogicApp.Basic","ConvertTo-Arm" -SubscriptionId "f5608f3d-ab28-49d8-9b4e-1b1f812d12e0" -ResourceGroup "TestRg" -Name "TestLogicApp"
...
.EXAMPLE
PS C:\> New-PsLaBuildByTask -Task "Export-LogicApp.AzCli","ConvertTo-LogicApp.Basic","ConvertTo-Arm" -OutputPath c:\temp\PsLaBuildfiles
...
.EXAMPLE
PS C:\> New-PsLaBuildByTask -Task "Export-LogicApp.AzCli","ConvertTo-LogicApp.Basic","ConvertTo-Arm" -IncludePrefixSuffix
...
function New-PsLaBuildByTask {
    ...
    foreach ($item in $Task) {
        $includes.Add("Include `"`$pathTasks\$item.task.ps1`"")
