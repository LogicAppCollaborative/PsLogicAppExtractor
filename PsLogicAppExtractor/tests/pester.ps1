...
Remove-Module PsLogicAppExtractor -ErrorAction Ignore
Import-Module "$PSScriptRoot\..\PsLogicAppExtractor.psd1"
Import-Module "$PSScriptRoot\..\PsLogicAppExtractor.psm1" -Force
