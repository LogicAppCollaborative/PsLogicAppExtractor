Describe 'Set-Raw.Actions.Servicebus.Queue.AsParm' {
    ...
    BeforeAll {
        ...
        Invoke-psake @parms -taskList "Set-Raw.Actions.Servicebus.Queue.AsParm"
    ...
    It "Should have a properties.definition.parameters.Queue001 property" {
        $lgObj.properties.definition.parameters.Queue001 | Should -Not -Be $null
    }

    It "Should be 'Inbound-Queue' in the properties.definition.parameters.Queue001.defaultValue property" {
        $lgObj.properties.definition.parameters.Queue001.defaultValue | Should -BeExactly "Inbound-Queue"
    }
