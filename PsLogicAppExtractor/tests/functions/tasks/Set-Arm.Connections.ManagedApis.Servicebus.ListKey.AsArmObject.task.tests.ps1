Describe 'Set-Arm.Connections.ManagedApis.Servicebus.ListKey.AsArmObject' {
    ...
    BeforeAll {
        ...
        Invoke-psake @parms -taskList "Set-Raw.ApiVersion", "ConvertTo-Arm", "Set-Arm.Connections.ManagedApis.Servicebus.ListKey.AsArmObject"
    ...
    It "Should have the needed parameters" {
        $armObj.parameters.servicebus_ResourceGroup | Should -Not -Be $null
        $armObj.parameters.servicebus_Namespace | Should -Not -Be $null
        $armObj.parameters.servicebus_Key | Should -Not -Be $null
