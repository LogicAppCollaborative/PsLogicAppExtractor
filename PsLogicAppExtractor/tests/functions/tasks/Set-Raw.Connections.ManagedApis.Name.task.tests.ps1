Describe 'Set-Raw.Connections.ManagedApis.Name' {
    ...
    BeforeAll {
        ...
        Invoke-psake @parms -taskList "Set-Raw.Connections.ManagedApis.Name"
    ...
    It 'Should be ''servicebus'' in the properties.parameters.$connections.value.servicebus.connectionName property' {
        $lgObj.properties.parameters.'$connections'.value.servicebus.connectionName | Should -BeExactly "servicebus"
    }
