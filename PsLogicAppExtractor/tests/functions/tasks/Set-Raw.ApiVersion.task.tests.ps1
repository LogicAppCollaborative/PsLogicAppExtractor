Describe 'Testing Set-Raw.ApiVersion' {
    ...
    BeforeAll {
        ...
        Invoke-psake @parms -taskList "Set-Raw.ApiVersion"
    ...
    It "Should have an apiVersion property" {
        $lgObj.apiVersion | Should -Not -Be $null
    }
