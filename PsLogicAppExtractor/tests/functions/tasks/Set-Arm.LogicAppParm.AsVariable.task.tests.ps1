Describe 'Testing Set-Arm.LogicApp.Parm.AsVariable' {
    ...
    BeforeAll {
        ...
        Invoke-psake @parms -taskList "Set-Raw.ApiVersion", "Set-Raw.Actions.Http.Uri.AsParm", "Set-Raw.Actions.Http.Audience.AsParm", "ConvertTo-Arm", "Set-Arm.LogicApp.Parm.AsVariable"
    ...
    It "Should be '[parameters('parm_EndpointAudience001')]' in the properties.definition.parameters.EndpointAudience001.defaultValue property" {
        $armObj.resources[0].properties.definition.parameters.EndpointAudience001.defaultValue | Should -BeExactly "[variables('parm_EndpointAudience001')]"
    }

    It "Should be '[parameters('parm_EndpointUri001')]' in the properties.definition.parameters.EndpointUri001.defaultValue property" {
        $armObj.resources[0].properties.definition.parameters.EndpointUri001.defaultValue | Should -BeExactly "[variables('parm_EndpointUri001')]"
    }

    It "Should have a variables.parm_EndpointUri001 property" {
        $armObj.variables.parm_EndpointUri001 | Should -Not -Be $null
    }

    It "Should be 'https://www.google.com' in the variables.parm_EndpointUri001 property" {
        $armObj.variables.parm_EndpointUri001 | Should -BeExactly "https://www.google.com"
    }

    It "Should have a variables.parm_EndpointAudience001 property" {
        $armObj.variables.parm_EndpointAudience001 | Should -Not -Be $null
    }

    It "Should be 'https://www.google.com' in the variables.parm_EndpointAudience001 property" {
        $armObj.variables.parm_EndpointAudience001 | Should -BeExactly "https://www.google.com"
    }
