<#
	.SYNOPSIS
		Installs the PsLogicAppExtractor Module from github
		
	.DESCRIPTION
		This script installs the PsLogicAppExtractor Module from github.
